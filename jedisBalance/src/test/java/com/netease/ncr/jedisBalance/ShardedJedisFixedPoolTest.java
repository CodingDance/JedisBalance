...
/**
 * @author hzyiting
 * @date 2015年8月27日 下午2:54:44
 */
public class ShardedJedisFixedPoolTest {
	@Test
	public void test() {
        ...
        //初始化ShardedJedisFixedPool
        IShardedJedisPool pool = new ShardedJedisFixedPool(poolConfig, addressList, "123456");
